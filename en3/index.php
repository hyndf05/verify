...
<html>
  <head>
    ...
    <title>VERIFY</title>
    <link rel="stylesheet" href="/with-iify/pack/css/main/main3.css" />
    ...
    <script defer src="/with-iify/pack/js/ja3.js"></script>
  </head>
  <body>
    <div class="wrap">
      <div class="scl">
      ...
      <div class="ccl">
        <div class="hhd">
          <span></span>
          <span>Please enter the number that presented.</span>
